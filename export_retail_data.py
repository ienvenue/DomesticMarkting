...
and (a.单据日期 between ods.first_day_of_the_month() and ods.yesterday_of_the_month())
...
c.center_name = a.中心名称
where (a.商品编码 in ('21038120000769', '21038120Z00761', '21038120Z00741', '21038110002413', '21038220000321', '21038120001209', '21038110002573')
and a.单据日期 between ods.first_day_of_the_month() and ods.yesterday_of_the_month())) d
where d.center <> '新疆'
...
and c.center = '新疆'
and (a.创建时间 between ods.first_day_of_the_month() and ods.yesterday_of_the_month())
