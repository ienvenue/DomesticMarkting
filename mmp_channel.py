...
channel_file = r'E:\Share\每日导数\二级9.27.xlsx'
...
channel_file = r'E:\Share\每日导数\一级9.27.xlsx'
channel_df = pd.read_excel(channel_file,sheet_name='   渠道出库明细',header=1,usecols=channel_use_col)
...
# mmp_file = r'F:\ChenYJ\Database\test\mmp零售数据.xlsx'
# mmp_df = pd.read_excel(mmp_file,sheet_name='Sheet0',header=0,usecols=mmp_use_col)
# mmp_df.to_sql('mmp零售数据', con=engine, if_exists='replace', index=False)
